...
public class CalcTaxaSActivity extends AppCompatActivity {
    Button btnCalcular;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_calc_taxa_s);
        ...
        btnCalcular.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(valorMonetario.getText().toString().equals("")){
                    ...
                    float result = juros / (cap * temp);
                    result *= 100;
                    DecimalFormat df = new DecimalFormat("##.##");
                    res.setText("Taxa de juros: " + df.format(result) + "%");
                }
            }
        });
    }
